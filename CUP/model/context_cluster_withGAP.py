...
class Grouper(nn.Module):
    ...
    def forward(self, x): #[b,c,w,h]
        ...
        # print("this is the shape of 1:{}///{}".format(centers.reshape(b,c,-1).permute(0,2,1).shape,x.reshape(b,c,-1).permute(0,2,1).shape))
        # print("this is the shape of :{}".format(pairwise_cos_sim(centers.reshape(b,c,-1).permute(0,2,1), x.reshape(b,c,-1).permute(0,2,1)).shape))
        ...
        # print("this is the shape of sim:{}".format(sim.shape))
...
@register_model
def coc_small_gap(pretrained=False, **kwargs):
    layers = [2, 2, 6, 2]
    norm_layer=GroupNorm
