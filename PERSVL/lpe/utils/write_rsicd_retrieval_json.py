...
def make_arrow(root, dataset_root):
    with open(f"{root}/dataset_rsicd.json", "r") as fp:
    ...
    for cap in tqdm(captions):
        ...
        iid2imgid[filename] = "rsicd_" + str(cap["imgid"])
    ...
    paths = list(glob(f"{root}/RSICD_images/*.jpg"))
...
if __name__ == '__main__':
    dir = r'/data1/amax/datasets/RSICD/'
