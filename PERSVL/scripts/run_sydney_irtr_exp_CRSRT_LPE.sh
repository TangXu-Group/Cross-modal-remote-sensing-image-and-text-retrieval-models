DATA_NAME='Sydney'
DATA_DIR='/data1/amax/datasets/Sydney_captions'
IMG_DIR='/data1/amax/datasets/Sydney_captions/root/imgs'
TRAIN_FILE1='json_root/sydney_train.json'
VAL_FILE='json_root/sydney_test.json'
TEST_FILE='json_root/sydney_test.json'
